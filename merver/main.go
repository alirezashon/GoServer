...
// 	urlWithParams := fmt.Sprintf("%s?userId=3198&status=Contractor---Round up&agentCode=%s&Category=%s", apiURL, requestBody.AgentID, requestBody.Accessories)
...
func handleAPIRequest(w http.ResponseWriter, r *http.Request) {
	...
	params.Set("status", "Contractor---Intact")
	params.Set("agentCode", requestBody.AgentID)
	params.Set("Category", requestBody.Accessories)
